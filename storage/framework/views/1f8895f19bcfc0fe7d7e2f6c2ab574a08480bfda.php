                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <div style="height: 200px; width: 200px; overflow:hidden;" class="m-auto">
                                            <img src="<?php echo e(asset($user->image)); ?>" alt="" class="img-fluid rounded-circle img-rounded">
                                        </div>
                                        <div class="mt-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-complete-blog-development\resources\views/admin/user/profile.blade.php ENDPATH**/ ?>