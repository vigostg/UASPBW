...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(route('dashboard')); ?>"><b>Dashboard</b></a>
        </div>
        <!-- /.login-logo -->
...
<?php /**PATH C:\laragon\www\laravel-complete-blog-development\resources\views/layouts/app.blade.php ENDPATH**/ ?>